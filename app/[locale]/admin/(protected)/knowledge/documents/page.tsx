...
export default async function AdminDocumentsPage() {
  ...
  const keys: (keyof DocLabels)[] = ["addNew","published","draft","edit","delete","save","cancel","publish","unpublish","confirmDelete","slug","slugHint","kind","number","title","issuer","adoptedAt","status","summary","summaryHint","keyPoints","keyPointsHint","tags","tagsHint","sourceUrl","checked","checkedHint","empty","loading","open","saved","error","filter","updates","addUpdate","updateDate","updateNote","updateSource","noUpdates","checkedAt","never","aiDraftBadge","aiDraftQuestion"];
